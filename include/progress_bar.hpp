...
namespace outStream
{
   ...
   private:
        ...
        bar_type max_, max_spin_, min_;
        bar_type iterating_var_, iterating_var_spin_, width_;
        std::string style_, style_p_, style_l_, type_, conct_; 
        std::string message_, brackets_open_, brackets_close_;
        std::string output_, color_, time_flag_;
